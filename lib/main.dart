...
import 'package:newproject/intro_screens/introscreen.dart';
...
import 'package:newproject/splashscreen/splashscreen.dart';
import 'package:newproject/tabs/second_tab.dart';
import 'package:provider/provider.dart';

import 'main_screens/drawer.dart';
import 'main_screens/location_sceen.dart';
import 'models/register_provider.dart';
      ...
      return MultiProvider(
        providers: [
          ChangeNotifierProvider(
            ...
            create: (BuildContext context) => TourProvider(),
          ),ChangeNotifierProvider(
            create: (BuildContext context) => TourOneIdProvider(),
          ),
        ],
        child: MaterialApp(
          title: 'Flutter Demo',
